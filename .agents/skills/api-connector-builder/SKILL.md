...
description: "Use when adding a new API connector or provider by matching the target repo's existing integration pattern without inventing a second architecture."
metadata:
  version: "1.0.0"
