...
description: "Use when introducing or refactoring toward Ports and Adapters (Hexagonal Architecture), establishing clear domain boundaries, dependency inversion, or untangling domain logic from I/O."
metadata:
  origin: ECC
---
